...
impl<R: MessageRepository> MessageService<R> {
    ...
    pub async fn create_message(
        ...
        self.repository
            .insert_message(sender_id, recipient_id, encrypted_content, signature, parent_id)
            .await
    }
    ...
    pub async fn get_conversation(
        ...
        self.repository.get_conversation(user1_id, user2_id, limit).await
    }
    ...
    pub async fn get_thread_replies(
        ...
        self.repository.get_thread_replies(parent_id, limit, offset).await
    }
    ...
    pub async fn get_complete_thread(
        ...
        self.repository.get_complete_thread(thread_root_id, limit).await
    }
...
mod tests {
    ...
    async fn test_create_message_success() {
        ...
        mock_repo
            ...
            .with(eq(sender_id), eq(recipient_id), eq(encrypted_content), eq(signature.clone()), eq(parent_id))
            .times(1)
    ...
    async fn test_get_conversation_success() {
        ...
        let service = MessageService::new(mock_repo);
        let result = service.get_conversation(user1_id, user2_id, limit).await.unwrap();
    ...
    async fn test_get_thread_replies_success() {
        ...
        let service = MessageService::new(mock_repo);
        let result = service.get_thread_replies(parent_id, limit, offset).await.unwrap();
    ...
    async fn test_get_complete_thread_success() {
        ...
        let service = MessageService::new(mock_repo);
        let result = service.get_complete_thread(thread_root_id, limit).await.unwrap();
